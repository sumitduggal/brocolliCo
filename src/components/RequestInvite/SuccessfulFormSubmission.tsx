...
export const SuccessfulFormSubmission = ({
  onRequestClose,
}: SuccessfulFormSubmissionProps) => {
  const handleOkButtonPress = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    onRequestClose();
  };
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <button className="btn btn-small w-full" onClick={handleOkButtonPress}>
        OK
      </button>
    </div>
  );
